...
class Interceptor extends \Magento\GraphQl\Controller\GraphQl implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Webapi\Response $response, \Magento\Framework\GraphQl\Schema\SchemaGeneratorInterface $schemaGenerator, \Magento\Framework\Serialize\SerializerInterface $jsonSerializer, \Magento\Framework\GraphQl\Query\QueryProcessor $queryProcessor, \Magento\Framework\GraphQl\Exception\ExceptionFormatter $graphQlError, \Magento\Framework\GraphQl\Query\Resolver\ContextInterface $resolverContext, \Magento\GraphQl\Controller\HttpRequestProcessor $requestProcessor, \Magento\Framework\GraphQl\Query\Fields $queryFields)
    {
        $this->___init();
        parent::__construct($response, $schemaGenerator, $jsonSerializer, $queryProcessor, $graphQlError, $resolverContext, $requestProcessor, $queryFields);
    }
